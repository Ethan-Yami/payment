<?php if(!defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Goods_model extends CI_Model{
		...
		*/
		...
		public function goodsall($tb,$select,$where,$join,$num,$offset,$time=array()){
			header("Content-type: text/html;charset=utf-8");
			...
			if(isset($join) && !empty($join)){
				...
				$this->db->join($join['table'],$join['on'],$join['way']);
        ...
        public function feiyeconfig($init= array(),$where=array()){
            ...
            $config['full_tag_open'] = '<ul class="pagination pagination-right">';
